...
Another thread of my work is to develop statistically and computationally efficient tools to better quantify uncertainty in the performance of stochastic systems. I am particularly interested in statistically flexible/robust formulations of stochastic models arising in, for example, queueing systems, where the focus has traditionally been on simpler, analytically tractable formulations. For example, one problem of interest is the nonparametric or semiparametric estimation of infinite-horizon performance measures for general state space Markov chains, using a dataset of observed driving noise and some knowledge of the chain's stochastic recursion function.
