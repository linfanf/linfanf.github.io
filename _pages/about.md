...
Another thread of my work is to develop statistically and computationally efficient tools to better quantify uncertainty in the performance of stochastic systems. I am particularly interested in statistically flexible/robust formulations of stochastic models arising in, for example, queueing systems, where the focus has traditionally been on simpler, analytically tractable formulations. For example, one problem I am interested in is the nonparametric and semiparametric estimation of infinite-horizon performance measures for general state space Markov chains, given a dataset of observed driving noise for the chain.
